...
<body>
                ...
                <div class="col-lg-12">
                    <div class="site-text">
                        ...
                        <div class="site-breadcrumb">
                            ...
                            <span class="sb-item">Nosotros</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="choseus-section set-bg spad" data-setbg="static/img/chose-us-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-trainer-item">
                        <div class="trainer-pic">
                            <img src="static/img/trainer/trainer-3.jpg" alt="">
                        </div>
                        <div class="trainer-text">
                            <h5>Noah Leonard</h5>
