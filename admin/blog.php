    ...
    <section class="breadcrumb-section set-bg" data-setbg="static/img/about-breadcrumb-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="site-text">
                        <h2>Opinión de nuestros visitantes</h2>
                        <div class="site-breadcrumb">
                            <a href="../indice.php.php" class="sb-item">Inicio</a>
                            <span class="sb-item">Blog</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single-blog-item">
                            <div class="row">
                                <div style="padding:20px" class="col-lg-6">
                                    <div class="blog-pic">
                                        <div style="background: url('static/img/blog-1.jpg'); height:350px; width: 500px;background-size:cover">
                                            <img style="margin-left:320px; margin-top:60px" src="images/c1.jpg" height="180px"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div style="margin-bottom:20px" class="blog-text">
                                <div class="blog-tag">
                                    <div class="post-info">
                                        <span>Julia Rose</span> - Dec 29, 2018
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div style="padding:20px" class="col-lg-6">
                                    <div class="blog-pic">
                                        <div style="background: url('static/img/blog-2.jpg'); height:350px; width: 500px;background-size:cover">
                                            <img style="margin-left:320px; margin-top:60px" src="images/c2.jpg" height="180px"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div style="margin-bottom:20px" class="blog-text">
                                <div class="blog-tag">
                                    <div class="post-info">
                                        <span>Jahnatan Smith</span> - Dec 29, 2018
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div style="padding:20px" class="col-lg-6">
                                    <div class="blog-pic">
                                        <div style="background: url('static/img/blog-1.jpg'); height:350px; width: 500px;background-size:cover">
                                            <img style="margin-left:320px; margin-top:60px" src="images/c3.jpg" height="180px"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div style="padding:20px" class="col-lg-6">
                                    <div class="blog-pic">
                                        <div style="background: url('static/img/blog-3.jpg'); height:350px; width: 500px;background-size:cover">
                                            <img style="margin-left:320px; margin-top:60px" src="images/c4.jpg" height="180px"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
