...
<html lang="en">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="menu menu--iris">
							...
							<p></p>
								<li class="menu__item"><a href="#about" class="menu__link scroll">Nuestras Canchas</a></li>
								<li class="menu__item"><a href="#team" class="menu__link scroll">Directivos</a></li>
	...
	<div class="col-md-12 book-form-left-w3layouts">
		<a href="admin/reservation.php"><h2>RESERVA UN AREA DEPORTIVA 
	</h2></a>
	</div>
	...
	<div class="team" id="team">
		<div class="container">
				<h3 class="title-w3-agileits title-black-wthree">Nuestro Personal</h3>
	...
	<section class="portfolio-w3ls" id="gallery">
			<h3 class="title-w3-agileits title-black-wthree">Nuestra galería</h3>
					<div class="col-md-3 gallery-grid gallery1">
						<a href="images/g01.jpg" class="swipebox">
							<img src="images/g01.jpg" class="img-responsive" alt="/">
							<div class="textbox">
								<h4>DESCUBRE</h4>
	...
	<!-- //gallery -->
		...
		<div class="plans-section" id="rooms">
					<div class="container">
					<h3 class="title-w3-agileits title-black-wthree">Areas Deportivas</h3>
	...
	<!-- visitors -->
		<div class="w3l-visitors-agile" >
			<div class="container">
					<h3 class="title-w3-agileits title-black-wthree">Opinion de los visitantes</h3> 
			</div>
